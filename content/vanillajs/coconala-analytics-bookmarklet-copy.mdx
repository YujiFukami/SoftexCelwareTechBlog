...
<CopyCode language="javascript" filename="coconala-analytics-bookmarklet.js" src="/articles/vanillajs/coconala-analytics-bookmarklet-copy/coconala-analytics-bookmarklet.js" />

ブックマークのURL欄へ登録するときは、このコードを一行にまとめ、先頭に`javascript:`を付けます。
